<?php
$livewirePath = __DIR__ . '/resources/views/livewire/smart-finance.blade.php';
$standardPath = __DIR__ . '/resources/views/smart_finance.blade.php';

$tailwindInjection = <<<'EOT'
...
function updateFile($filepath, $tailwindInjection) {
    ...
    $newContent = preg_replace('/<style>.*?<\/style>/s', $tailwindInjection, $content);
    
    if ($newContent !== null) {
        file_put_contents($filepath, $newContent);
        echo "Updated $filepath\n";
    } else {
        echo "Regex failed on $filepath\n";
    }
}

updateFile($livewirePath, $tailwindInjection);
updateFile($standardPath, $tailwindInjection);
