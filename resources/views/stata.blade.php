    ...
    @php
        $stataCommandGroups = [
            ...
            'Regresi, Uji, dan Postestimation' => [
                ...
                ['cmd' => 'tobit', 'desc' => 'Model regresi Tobit untuk variabel dependen yang disensor (memiliki batas nilai).', 'example' => 'tobit hours wage educ, ll(0)'],
                ['cmd' => 'ologit', 'desc' => 'Model regresi logistik ordinal untuk dependen dengan tingkatan/urutan.', 'example' => 'ologit satisfaction income health'],
                ['cmd' => 'mlogit', 'desc' => 'Model logistik multinomial untuk dependen kategori tanpa urutan.', 'example' => 'mlogit choice price income'],
        ...
        if (app()->getLocale() === 'en') {
            $stataCommandGroups = [
                ...
                'Regression, Tests, and Postestimation' => [
                    ...
                    ['cmd' => 'tobit', 'desc' => 'Run a Tobit regression for censored dependent variables.', 'example' => 'tobit hours wage educ, ll(0)'],
                    ['cmd' => 'ologit', 'desc' => 'Run an ordered logistic regression for ordinal outcomes.', 'example' => 'ologit satisfaction income health'],
                    ['cmd' => 'mlogit', 'desc' => 'Run a multinomial logistic regression for categorical outcomes.', 'example' => 'mlogit choice price income'],
